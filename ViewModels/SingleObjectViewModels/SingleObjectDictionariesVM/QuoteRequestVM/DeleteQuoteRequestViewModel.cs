...
{
    public class DeleteQuoteRequestViewModel : DeleteViewModel<QuoteRequest>
    {
        public DeleteQuoteRequestViewModel()
            : base("Delete Quote Request")
        {
        }

        protected override string RefreshMessageTag => "Quote Requests";
