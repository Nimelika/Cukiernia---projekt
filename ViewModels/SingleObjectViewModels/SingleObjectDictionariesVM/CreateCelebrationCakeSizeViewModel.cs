...
{
    public class CreateCelebrationCakeSizeViewModel : SingleViewModel<CelebrationCakeSize> //bo wszystkie zak³adki dziedzicz¹ po WVM
	{
		...
		#region Konstruktor
		public CreateCelebrationCakeSizeViewModel()
			: base("Celebration Cake Size")
		{
			item = new CelebrationCakeSize();
		}
		#endregion
